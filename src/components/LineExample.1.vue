...
export default {
  ...
  mounted: function () {
    var self = this
    self.$data.PIXI = require('pixi.js')
    self.$data.app = new self.$data.PIXI.Application(800, 600, {antialias: true, backgroundColor: 0xeeeeee})
    document.getElementById(self.$data.canvasID).appendChild(self.$data.app.view)
  }
}
</script>
